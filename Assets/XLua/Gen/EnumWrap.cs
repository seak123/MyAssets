...
namespace XLua.CSObjectWrap
{
    ...
    public class UILayerWrap
    {
		public static void __Register(RealStatePtr L)
        {
			...
			Utils.BeginClassRegister(typeof(UILayer), L, null, 3, 0, 0);

            
            Utils.RegisterObject(L, translator, Utils.CLS_IDX, "MainLayer_0", UILayer.MainLayer_0);
            
            Utils.RegisterObject(L, translator, Utils.CLS_IDX, "NoticeLayer", UILayer.NoticeLayer);
        ...
        static int __CastFrom(RealStatePtr L)
		{
            ...
            else if(lua_type == LuaTypes.LUA_TSTRING)
            {
			    ...
			    if (LuaAPI.xlua_is_eq_str(L, 1, "MainLayer_0"))
                {
                    translator.PushUILayer(L, UILayer.MainLayer_0);
                }
				else if (LuaAPI.xlua_is_eq_str(L, 1, "NoticeLayer"))
                {
                    translator.PushUILayer(L, UILayer.NoticeLayer);
                }
				else
                {
