...
namespace XLua.CSObjectWrap
{
    public class XLua_Gen_Initer_Register__
	{
        ...
        static void wrapInit0(LuaEnv luaenv, ObjectTranslator translator)
        {
            ...
            translator.DelayWrapLoader(typeof(BattleInputParam), BattleInputParamWrap.__Register);
        
        
            translator.DelayWrapLoader(typeof(BattleManager), BattleManagerWrap.__Register);
        
        
            translator.DelayWrapLoader(typeof(LuaOperation), LuaOperationWrap.__Register);
        
        
            translator.DelayWrapLoader(typeof(GameSceneManager), GameSceneManagerWrap.__Register);
        
        
            translator.DelayWrapLoader(typeof(SceneUtil), SceneUtilWrap.__Register);
            ...
            translator.DelayWrapLoader(typeof(LuaCallCSharpUtil), LuaCallCSharpUtilWrap.__Register);
        
        
            translator.DelayWrapLoader(typeof(MapManager), MapManagerWrap.__Register);
        
        
            translator.DelayWrapLoader(typeof(Performer), PerformerWrap.__Register);
        
        
            translator.DelayWrapLoader(typeof(CameraManager), CameraManagerWrap.__Register);
        
        
            translator.DelayWrapLoader(typeof(CardItem), CardItemWrap.__Register);
        
        
            translator.DelayWrapLoader(typeof(UILayer), UILayerWrap.__Register);
        
        
            translator.DelayWrapLoader(typeof(WindowsUtil), WindowsUtilWrap.__Register);
        ...
        static void Init(LuaEnv luaenv, ObjectTranslator translator)
        {
            ...
            translator.AddInterfaceBridgeCreator(typeof(ILuaBehaviourManager), ILuaBehaviourManagerBridge.__Create);
            
            translator.AddInterfaceBridgeCreator(typeof(ILuaEventManager), ILuaEventManagerBridge.__Create);
